...
print('Added 6 time slots for Speeder Bike Chase')
...
print('Added 6 time slots for AT-ST Rampage Coaster')
...
print('Added 6 time slots for Wicket\'s Wild Treehouse Drop')

print('Period 2 sample data complete!')
